...
/*EX 1*/
SELECT num_ped, cod_prod, qtd_ped
...
/*EX 4*/
SELECT cod_prod, qtd_ped
FROM item_pedido, pedido, produto
WHERE qtd_ped = 500;

/*EX 5*/
SELECT cod_prod, unid_prod, val_unit 
FROM produto
WHERE unid_prod = 'kg' AND val_unit > 2;

/*EX 6*/
SELECT nome_cli, cep FROM cliente
WHERE cidade = 'sao paulo'
OR cep BETWEEN '20000005' AND '20000010';
